...
<Quiz
  question="Which method is used to print text to the console in Java?"
  options={["System.out.print()", "System.out.println()", "Both", "None"]}
  correctAnswerIndex={2}
/>

### Difference between println() and print() and printf()
...
<Quiz
  question="Which class is primarily used for taking input from the user in Java?"
  options={["System", "Scanner", "Input", "Reader"]}
...
**Tip 💡:** `Scanner` is like a magical listener. But it lives in a different package, so you MUST `import java.util.Scanner;` at the top of your file to use it!
...
We can talk to the user now! Next, let's learn how to organize our code and make decisions.
[Learn about Comments →](/docs/comments)
