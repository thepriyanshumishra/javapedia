...
If two keys have the same hash code (Collision), they are stored in the same "bucket" (usually a LinkedList or Balanced Tree). Java handles this automatically!
