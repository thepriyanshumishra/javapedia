...
<Quiz
  question="Which operator is used for finding the remainder?"
  options={["/", "%", "*", "&"]}
...
We can calculate things, but how do we interact with the user?
[Basic Input & Output →](/docs/basic-input-output)
