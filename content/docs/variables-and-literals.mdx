...
To indicate the storage area, each variable should be given a unique name (identifier). Learn more about [Java identifiers](https://javapedia.vercel.app/java-introduction/keywords-identifiers).
