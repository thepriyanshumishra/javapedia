...
// ... (ContactInfoItem remains unchanged) ...
...
const contactMethods: ContactMethod[] = [
  ...
  },
  {
    ...
    href: "https://github.com/thepriyanshumishra/javapedia/issues",
  },
  {
...
export default function ContactUsPage() {
  ...
  const contactMethods: ContactMethod[] = [
    ...
    },
    {
      ...
      colorClass:
        "border-purple-500/20 bg-purple-50 text-purple-700 hover:border-purple-500/40 hover:bg-purple-100 dark:bg-purple-900/20 dark:text-purple-400",
      href: "https://github.com/thepriyanshumishra/javapedia/commits",
    },
  ];
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <ContactInfoItem
                    icon={Mail}
                    title="Email"
                    description="thedarkpcm@gmail.com"
                    href="mailto:thedarkpcm@gmail.com"
                  />
                  <ContactInfoItem
                    icon={GitHubIcon}
                    title="GitHub"
                    description="github.com/thepriyanshumishra/javapedia"
                    href="https://github.com/thepriyanshumishra/javapedia"
                  />
                  <ContactInfoItem
                    icon={LinkedInIcon}
