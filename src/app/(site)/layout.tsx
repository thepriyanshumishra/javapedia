              ...
              <NavbarMenu>
                ...
                <NavbarMenuContent className="p-2 text-[15px]">
                  <NavbarMenuLink href="/about" className="md:row-span-2">
                    ...
                    <p className="font-medium">About Javapedia</p>
                    <p className="text-fd-muted-foreground text-sm">
                  ...
                  >
                    ...
                    <p className="text-fd-muted-foreground text-sm">
                      Contribute to Javapedia on GitHub and help improve Java
                      education.
                    </p>
                  </NavbarMenuLink>

                  <NavbarMenuLink
                    href="https://github.com/thepriyanshumishra/javapedia/graphs/contributors"
                    className="lg:col-start-2"
                  >
                    <Users className="bg-fd-primary text-fd-primary-foreground mb-2 rounded-md p-1" />
                    <p className="font-medium">Contributors</p>
                    <p className="text-fd-muted-foreground text-sm">
                      Meet the amazing developers building Javapedia together.
                    </p>
                  </NavbarMenuLink>
