  ...
  return (
    <main className="container max-w-4xl pt-20 max-sm:px-0 md:pb-12">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Welcome to Javapedia (&quot;we,&quot; &quot;our,&quot; or
        ...
        <p>
          <strong>Important:</strong> Javapedia does not require user accounts
          and does not collect personal information from visitors.
        </p>

        <h2>2. Information We Do Not Collect</h2>
        <p>
          Unlike many web platforms, Javapedia is designed as a static
        ...
        <p>
          If you choose to contribute to the Javapedia project through our
        ...
        <p>
          Javapedia may be hosted on third-party platforms (such as Vercel,
        ...
        <p>
          Javapedia uses various open source libraries and frameworks. These
        ...
        <p>
          Javapedia is an educational platform intended for learners of all ages
        ...
        <p>
          As an open source educational platform, Javapedia is accessible
        ...
        <p>
          Javapedia is an open source project licensed under the MIT License.
          All licenses are publicly available in our repository.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Community Channels:</strong> LinkedIn, GitHub Discussions
          </li>
          <li>
