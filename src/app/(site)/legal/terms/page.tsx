    ...
    <main className="container max-w-4xl pt-20 max-sm:px-0 md:pb-12">
      <div className="mb-8 text-center">
        ...
        <p className="mb-6 text-lg text-neutral-600 dark:text-neutral-400">
          Please read these terms carefully before using Javapedia. This is an
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          By accessing and using Javapedia (&quot;the Platform,&quot;
        ...
        <p>
          Javapedia is a free, open source educational platform designed to
        ...
        <p>
          <strong>Important:</strong> Javapedia is provided free of charge and
          does not require user accounts or collect personal information.
        </p>

        <h2>3. Open Source Nature</h2>
        <p>
          Javapedia is an open source project released under the MIT License.
          This means:
        </p>
        <ul>
          <li>The platform&apos;s source code is publicly available</li>
          <li>
            You are free to view, modify, and distribute the code under the MIT
            License
          </li>
        ...
        <p>
          All content on Javapedia, including tutorials, documentation, and code
        ...
        <p>
          Javapedia is licensed under the MIT License. Please refer to the
          LICENSE file in the repository for complete terms.
        </p>
        ...
        <p>
          Javapedia may accept sponsorships or donations to support development
        ...
        <p>
          To the fullest extent permitted by applicable law, Javapedia
        ...
        <p>
          You agree to defend, indemnify, and hold harmless Javapedia
        ...
        <p>
          These Terms constitute the entire agreement between you and Javapedia
