          ...
          >
            ...
            >
              <Button
                ...
                aria-label="View Javapedia project on GitHub"
              >
            ...
            >
              <Button
                ...
                aria-label="Star Javapedia repository"
              >
          ...
          >
            {[
              ...
              },
              {
                ...
                text: "MIT Licensed",
                link: "https://github.com/thepriyanshumishra/javapedia/blob/main/LICENSE",
              },
            ].map((indicator, index) => (
              <motion.div
                key={index}
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground mx-auto mt-6 max-w-4xl text-lg font-medium sm:text-xl">
              ...
              contributing to Javapedia and make an impact on programming
              education worldwide.
            </p>
          </motion.div>
          ...
          >
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="group">
                ...
                <div className="space-y-4">
                  <a
                    href="https://github.com/thepriyanshumishra/javapedia/blob/main/CODE_OF_CONDUCT.md"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://github.com/thepriyanshumishra/javapedia/blob/main/CONTRIBUTING.md"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="border-border bg-muted hover:bg-muted/80 block rounded-md border p-4 transition-colors"
                  >
        ...
        >
          ...
          >
            ...
            >
              ...
              <motion.a
                href="https://github.com/thepriyanshumishra/javapedia/stargazers"
                target="_blank"
                rel="noopener noreferrer"
