                        ...
                        {[
                          {
                            name: "Source Code",
                            type: "GitHub",
                            url: "https://github.com/thepriyanshumishra/javapedia",
                          },
              ...
              <div className="rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 p-6 dark:from-blue-500/20 dark:to-indigo-500/20">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-blue-600 dark:text-blue-400">
                      <Link href="https://github.com/thepriyanshumishra/javapedia/issues">
                        Report Issue
                      </Link>
                    </span>
                  </div>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Link href="https://github.com/thepriyanshumishra/javapedia">
                <motion.button
