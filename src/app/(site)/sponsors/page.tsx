        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button asChild className="w-full">
              <Link href="https://opencollective.com/javapedia" target="_blank">
      ...
      <motion.section className="mb-20" variants={ANIMATION_VARIANTS.container}>
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground mb-4 text-sm">
              Help us reach more developers by sharing Javapedia with your
              network and professional communities.
            </p>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="outline" size="sm" asChild>
                <Link
                  href="https://x.com/intent/tweet?text=Empowering%20Java%20developers%20worldwide%20with%20free%20education%20at%20@javapedia!%20🚀&url=https://javapedia.vercel.app"
                  target="_blank"
                >
                  Share on X
                </Link>
