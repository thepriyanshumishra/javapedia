...
const FAQ_ITEMS: FAQItem[] = [
  {
    question: "Is Javapedia really free?",
    answer:
      "Yes! Javapedia is completely free and always will be. We believe quality programming education should be accessible to everyone, regardless of their financial situation. No premium tiers, no hidden costs, no paywalls.",
  },
  {
  ...
  {
    question: "What makes Javapedia different from other learning platforms?",
    answer:
      "Javapedia is specifically focused on Java programming with hands-on, practical examples. Unlike generic coding platforms, we provide deep, comprehensive Java education that's completely free and community-driven. Our content is created by experienced Java developers for real-world application.",
  },
  {
    question: "How can I contribute to Javapedia?",
    answer:
  ...
  {
    question: "Can I use Javapedia content for teaching?",
    answer:
