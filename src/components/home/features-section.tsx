...
export function FeaturesSection() {
    ...
    () => [
      {
        ...
        imageRotation: 0.5,
        imageAlt:
          "Beautiful user interface design showcasing Javapedia's clean and modern look",
        imageWidth: 400,
        imageHeight: 300,
      },
      {
      ...
      },
      {
        ...
        onClick: () =>
          window.open(
            "https://github.com/thepriyanshumishra/javapedia",
            "_blank",
          ),
        imageRotation: 0.5,
  ...
  return (
    ...
    >
      ...
      >
        At Javapedia, every feature is designed to make learning effortless and
        inspiring.
      </motion.p>
      <motion.div
        ...
        animate="visible"
        role="group"
        aria-label="Key features of Javapedia"
      >
