  ...
  const TAB_ITEMS: UnderlineTab[] = [
    {
      ...
      content: (
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl shadow-lg sm:rounded-3xl">
          <iframe
            src="/docs"
            title="Java programming docs preview"
